...
- Install **[Renode](https://github.com/renode/renode?tab=readme-ov-file#installation)**
- Run `./run.sh simulation/*.resc` in your terminal
...
```C++
.
├── 📁 simulation          // Renode emulation script
